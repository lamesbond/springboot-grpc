package com.axin.test.grpcserver;
...
public final class TestGrpcServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.axin.test.grpcserver.TestRequest,
      com.axin.test.grpcserver.TestReply> getTestMethodMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "testMethod",
      requestType = com.axin.test.grpcserver.TestRequest.class,
      responseType = com.axin.test.grpcserver.TestReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axin.test.grpcserver.TestRequest,
      com.axin.test.grpcserver.TestReply> getTestMethodMethod() {
    io.grpc.MethodDescriptor<com.axin.test.grpcserver.TestRequest, com.axin.test.grpcserver.TestReply> getTestMethodMethod;
      ...
      synchronized (TestGrpcServiceGrpc.class) {
        if ((getTestMethodMethod = TestGrpcServiceGrpc.getTestMethodMethod) == null) {
          TestGrpcServiceGrpc.getTestMethodMethod = getTestMethodMethod =
              io.grpc.MethodDescriptor.<com.axin.test.grpcserver.TestRequest, com.axin.test.grpcserver.TestReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "testMethod"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axin.test.grpcserver.TestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axin.test.grpcserver.TestReply.getDefaultInstance()))
  ...
  public static abstract class TestGrpcServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void testMethod(com.axin.test.grpcserver.TestRequest request,
        io.grpc.stub.StreamObserver<com.axin.test.grpcserver.TestReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.axin.test.grpcserver.TestRequest,
                com.axin.test.grpcserver.TestReply>(
  ...
  public static final class TestGrpcServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TestGrpcServiceBlockingStub> {
    ...
    /**
     */
    public com.axin.test.grpcserver.TestReply testMethod(com.axin.test.grpcserver.TestRequest request) {
  ...
  public static final class TestGrpcServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TestGrpcServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axin.test.grpcserver.TestReply> testMethod(
        com.axin.test.grpcserver.TestRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TEST_METHOD:
          serviceImpl.testMethod((com.axin.test.grpcserver.TestRequest) request,
              (io.grpc.stub.StreamObserver<com.axin.test.grpcserver.TestReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class TestGrpcServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.axin.test.grpcserver.Test1.getDescriptor();
    }
